...
public class Test5 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        File screenshotsFolder = new File("screenshots5");
        ...
        for (Dimension resolution : resolutions) {
            ...
            cdriver.findElement(By.xpath("//*[@id=\"sitemap\"]/tbody/tr[5]/td[1]/a")).click();
            ...
            fdriver.findElement(By.xpath("//*[@id=\"sitemap\"]/tbody/tr[5]/td[1]/a")).click();
    ...
    public static void captureScreenshot(WebDriver driver, Dimension resolution) {
        ...
        try {
            ...
            FileUtils.copyFile(screenshot5,
                    new File("screenshots5/screenshot_" + resolution.getWidth() + "x" + resolution.getHeight() + "_"
