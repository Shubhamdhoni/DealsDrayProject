...
public class Test3 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        File screenshotsFolder = new File("screenshots3");
        ...
        for (Dimension resolution : resolutions) {
            ...
            cdriver.findElement(By.xpath("//*[@id=\"sitemap\"]/tbody/tr[3]/td[1]/a")).click();
            ...
            fdriver.findElement(By.xpath("//*[@id=\"sitemap\"]/tbody/tr[3]/td[1]/a")).click();
    ...
    public static void captureScreenshot(WebDriver driver, Dimension resolution) {
        ...
        try {
            ...
            FileUtils.copyFile(screenshot3,
                    new File("screenshots3/screenshot_" + resolution.getWidth() + "x" + resolution.getHeight() + "_"
